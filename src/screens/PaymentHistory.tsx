...
const transactions: Transaction[] = [
  { id: 't1', type: 'train', line: 'Stouffville Line', from: 'Miliken GO', to: 'Union Station GO', date: 'Today', time: '10:54 AM', amount: '$9.05', method: 'eticket' },
  { id: 't2', type: 'train', line: 'Stouffville Line', from: 'Union Station GO', to: 'Miliken GO', date: 'Today', time: '5:30 PM', amount: '$7.62', method: 'presto' },
  { id: 't3', type: 'train', line: 'Lakeshore East', from: 'Union Station GO', to: 'Oshawa GO', date: 'May 9', time: '9:15 AM', amount: '$10.40', method: 'presto' },
  { id: 't4', type: 'bus', line: 'Route 18', from: 'Port Credit GO', to: 'Clarkson GO', date: 'May 8', time: '3:20 PM', amount: '$4.25', method: 'presto' },
  { id: 't5', type: 'train', line: 'Barrie Line', from: 'Union Station GO', to: 'Aurora GO', date: 'May 7', time: '8:30 AM', amount: '$9.10', method: 'presto' },
  { id: 't6', type: 'train', line: 'Lakeshore West', from: 'Union Station GO', to: 'Burlington GO', date: 'May 5', time: '10:00 AM', amount: '$11.50', method: 'eticket' },
  { id: 't7', type: 'train', line: 'Stouffville Line', from: 'Miliken GO', to: 'Union Station GO', date: 'May 4', time: '7:45 AM', amount: '$7.62', method: 'presto' },
]
...
export default function PaymentHistory() {
  ...
  const totalSpent = transactions.reduce((sum, tx) => sum + parseFloat(tx.amount.replace('$', '')), 0)
